...
/**
 * This is the ActiveQuery class for [[TransactionTransfer]].
 *
 * @see TransactionTransfer
 */
class TransactionTransferQuery extends \yii\db\ActiveQuery
{
    ...
    /*public function active()
    {
        return $this->andWhere(['status' => TransactionTransfer::STATUS_PUBLISHED]);
    }*/

    /**
     * @inheritdoc
     * @return TransactionTransfer[]|array
     */
    ...
    /**
     * @inheritdoc
     * @return TransactionTransfer|array|null
     */
